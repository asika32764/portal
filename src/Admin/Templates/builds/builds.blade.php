...
<div id="phoenix-admin" class="builds-container grid-container">
    <form name="admin-form" id="admin-form" action="{{ $router->route('builds') }}" method="POST" enctype="multipart/form-data">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th width="5%" class="nowrap">
                        {!! $grid->sortTitle('admin.build.field.ordering', 'build.ordering') !!} {!! $grid->saveorderButton() !!}
                    </th>
                    ...
                    {{-- LANGUAGE --}}
                    <th width="7%">
                        {!! $grid->sortTitle('admin.build.field.language', 'build.language') !!}
                    </th>
                ...
                @foreach ($items as $i => $item)
                    ...
                    <tr>
                        ...
                        {{-- TITLE --}}
                        <td>
                            <a href="{{ $router->route('build', ['id' => $item->id]) }}">
                                {{ $item->title }}
                            </a>
                        </td>
                ...
                <tr>
                    {{-- PAGINATION --}}
                    <td colspan="25">
                        {!! $pagination->route('builds', [])->render() !!}
                    </td>
                </tr>
                </tfoot>
            </table>
