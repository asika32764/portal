...
/**
 * The PipelineMapper class.
 * 
 * @since  1.0
 */
class PipelineMapper extends CoreDataMapper
{
	/**
	 * Property table.
	 *
	 * @var  string
	 */
	protected static $table = Table::PIPELINES;
	 ...
	 * @var  string
	 */
	protected static $alias = 'pipeline';
	 ...
	 * @var  string
	 */
	protected static $dataClass = PipelineRecord::class;
